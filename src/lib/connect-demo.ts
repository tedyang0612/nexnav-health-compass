...
export const CONNECT_DEMO_FACILITIES: ConnectFacility[] = [
  ...
  { id: 8, name: "鳳O吉O聯合診所", specialty: "預防醫學", distanceKm: 1.4, area: "南京東路三段 303 巷 6 弄 9 號", symptoms: ["頭痛", "疲倦", "腹部"], openToday: false, mapsName: "鳳凰吉祥聯合診所", mapsAddress: "台北市松山區南京東路三段303巷6弄9號1樓" },
