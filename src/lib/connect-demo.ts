...
export const CONNECT_DEMO_FACILITIES: ConnectFacility[] = [
  { id: 1, name: "全O耳鼻喉科診所", specialty: "耳鼻喉科", distanceKm: 0.2, area: "南京東路三段", symptoms: ["頭痛", "頭暈", "耳鼻喉"], openToday: true },
  ...
  { id: 5, name: "民O家庭醫學診所", specialty: "家庭醫學科", distanceKm: 0.9, area: "民生東路三段", symptoms: ["頭痛", "頭暈", "疲倦", "腹部"], openToday: true },
  { id: 6, name: "復O皮膚科診所", specialty: "皮膚科", distanceKm: 1.0, area: "復興南路一段", symptoms: ["皮膚", "過敏"], openToday: false },
  { id: 7, name: "榮O耳鼻喉科診所", specialty: "耳鼻喉科", distanceKm: 1.2, area: "長春路", symptoms: ["頭痛", "頭暈", "耳鼻喉"], openToday: true },
  { id: 8, name: "安O家庭醫學科診所", specialty: "家庭醫學科", distanceKm: 1.4, area: "八德路二段", symptoms: ["頭痛", "疲倦", "腹部"], openToday: false },
  ...
  { id: 12, name: "致O神經內科診所", specialty: "神經內科", distanceKm: 2.2, area: "忠孝東路四段", symptoms: ["頭痛", "頭暈", "麻木"], openToday: true },
